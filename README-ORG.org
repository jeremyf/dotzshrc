...
In reading "How to Take Smart Notes" by Sonke Ahrens, the author discusses three types of notes:
 ...
 #+END_SRC
  ...
  - [[file:./bin/create-index-for-permanent-cards][file:./bin/create-index-for-permanent-cards]] :: Creates an index of the permanent cards
  - [[file:./bin/sort-unsorted][./bin/sort-unsorted]] :: Provides tooling to move files into the permanent/cards directory
