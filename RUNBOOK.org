...
- =brew install util-linux= :: add linux commands to MacOS
...
- =brew install syncthing= :: get that up and running to send syncs everywhere.

I then install the device syncthing clients.  I’m exploring how I’ll use it.
But began some exploration.
