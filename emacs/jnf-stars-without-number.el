...
(defun swn-npc (culture &optional)
  "Capture a random `swnt' NPC with the given CULTURE in the Thel Sector org project."
 ...
 (let* ((npc-string-list (split-string-and-unquote (shell-command-to-string (concat "swnt new npc --is-patron --culture " culture)) "\n"))
         ...
         (fpath (f-join org-directory "projects" "thel-sector" (concat (format-time-string "%Y%m%d---") (s-snake-case npc-name) ".org"))))
