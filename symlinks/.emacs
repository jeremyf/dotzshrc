...
(setq org-capture-templates
      '(
        ("c" "Write to Current Clock" plain (clock)
         "%?\n %a")
        ("m" "Meeting for Work" entry (file+datetree "~/git/org/workday.org")
         "* MEETING %^{SUMMARY}\n\n  %^{ATTENDEES}p\n  %?\n")
        ("r" "Reading for Work" entry (file+datetree "~/git/org/workday.org")
         "* TO-READ %^{SUBJECT} %u\n  %?\n")
        ...
        ("t" "Task for Work" entry (file+datetree "~/git/org/workday.org")
         "* TODO %?")
        ("w" "Waiting for Work" entry (file+datetree "~/git/org/workday.org")
         "* WAITING %^{SUMMARY}\n\n  %?\n")
        ))
